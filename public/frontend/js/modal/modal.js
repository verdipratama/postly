...
function embed_video() {
  document.execCommand(
    "copy",
    false,
    document.getElementById("embed_video").select()
  );
...
function embed(slug) {
  ...
  $(".ellipish-list").html(
    '<textarea id="embed_video" class="embed_textarea"><iframe src="' +
      video_url +
      '" frameborder="0" width="100%" height="100%"></iframe></textarea><a href="javascript:void(0)" onclick="embed_video()" class="embed_action">Copy Embed Code</a>'
  );
}
...
function share(slug) {
  ...
  $(".ellipish-modal").removeClass("d-none");
  $(".ellipish-list").html(
    '<div class="share-header"><h4>Share</h4><div class="single-share"><a target="_blank" href="https://www.facebook.com/dialog/share?app_id=87741124305&href=' +
      video_url +
      '%3Fv%3DRCEKC6wpj6M%26feature%3Dshare&display=popup"><i class="fab fa-facebook"></i><span>Share to Facebook</span></a></div><div class="single-share"><a target="__blank" href="https://pinterest.com/pin/create/button/?url=' +
      video_url +
      '"><i class="fab fa-pinterest"></i><span>Share to Pinterest</span></a></div><div class="single-share"><a target="__blank" href="https://twitter.com/intent/tweet?url=' +
      video_url +
      "&text=" +
      slug +
      '"><i class="fab fa-twitter-square"></i><span>Share to Twitter</span></a></div><div class="single-share"><a target="__blank" href="mailto:?subject=' +
      slug +
      "&amp;body=Check out this site " +
      video_url +
      '."><i class="far fa-envelope"></i><span>Share via Email</span></a></div><div class="single-share"><a href="javascript:void(0)" onclick="copy_link()"><i class="fas fa-link"></i><span>Copy Link</span></a></div><div class="single-share"><a href="javascript:void(0)" onclick="cancel_ellipish()"><i class="far fa-times-circle"></i><span>Cancel</span></a></div></div>'
  );
}
...
function report(slug) {
  ...
  $.ajax({
    ...
    beforeSend: function () {
      $(".ellipish-modal").removeClass("d-none");
      $(".ellipish-list").html(
        '<form id="report_form"><textarea id="embed_video" class="embed_textarea" placeholder="Write report issue"></textarea><button type="submit" class="embed_action">Send Report</button></form>'
      );
    },
    success: function (response) {
      $(".ellipish-modal").removeClass("d-none");
